...
//    rnd = rnd.host_copy();
//    auto rnd2 = compute_random_numbers_with_fixed_seed(use_cuda).host_copy();
//    for (unsigned i = 0; i < rnd.host_vector().size(); ++i) {
//        CHECK(rnd.host_vector()[i] == rnd2.host_vector()[i]);
//    }
//}
