...
Tensor<T, 1> concat(const Tensor<T, n_dims_a>& a, const Tensor<T, n_dims_b>& b)
{
...
Tensor<T, 1> concat(const Tensor<T, n_dims_a>& a, const Tensor<T, n_dims_b>& b, TensorTypes... params)
{
